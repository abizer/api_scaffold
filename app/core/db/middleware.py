"""Adapted from fastapi_async_sqlalchemy.
...
def create_middleware_and_session_proxy():
    ...
    class SQLModelMiddleware(BaseHTTPMiddleware):
        def __init__(
            self,
            app: ASGIApp,
    ...
    return SQLModelMiddleware, DBSession


SQLModelMiddleware, db = create_middleware_and_session_proxy()
