...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_rbac_projects_name"), "rbac_projects", ["name"], unique=True
    )
    ...
    op.drop_constraint(
        "rbac_projects_resource_id_fkey", "rbac_projects", type_="foreignkey"
    )
    op.create_foreign_key(
        "rbac_projects_resource_id_fkey",
        "rbac_projects",
        "rbac_resources",
        ["resource_id"],
        ["resource_id"],
    ...
    op.drop_constraint(
        "rbac_role_resource_associations_resource_id_fkey",
        "rbac_role_resource_associations",
        type_="foreignkey",
    )
    op.create_foreign_key(
        "rbac_role_resource_associations_resource_id_fkey",
    ...
    op.drop_constraint(
        "rbac_role_resource_associations_role_id_fkey",
        "rbac_role_resource_associations",
        type_="foreignkey",
    )
    op.create_foreign_key(
    ...
    op.drop_constraint(
        "rbac_projects_organization_id_fkey", "rbac_projects", type_="foreignkey"
    )
    op.create_foreign_key(
        "rbac_projects_organization_id_fkey",
        "rbac_projects",
        "rbac_orgs",
        ["organization_id"],
        ["id"],
...
def downgrade() -> None:
    ...
    op.drop_constraint("rbac_keys_role_id_fkey", "rbac_keys", type_="foreignkey")
    op.create_foreign_key(
        "rbac_keys_role_id_fkey", "rbac_keys", "rbac_roles", ["role_id"], ["id"]
    )
    op.drop_constraint("rbac_keys_user_id_fkey", "rbac_keys", type_="foreignkey")
    op.create_foreign_key(
        "rbac_keys_user_id_fkey", "rbac_keys", "rbac_users", ["user_id"], ["id"]
    )
